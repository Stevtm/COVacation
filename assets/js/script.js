...
function showFlightInfo() {
	...
	fetch(`https://skyscanner-skyscanner-flight-search-v1.p.rapidapi.com/apiservices/autosuggest/v1.0/CA/CAD/en-US/?query=${departFrom}`, {
	"method": "GET",
	"headers": {
		"x-rapidapi-key": "e94756adcfmsh4384f35646a8fc5p17f530jsn906fc3f8b7a4",
		"x-rapidapi-host": "skyscanner-skyscanner-flight-search-v1.p.rapidapi.com"
	...
	.then(response => {
		response.json().then(data => {
			...
			fetch(`https://skyscanner-skyscanner-flight-search-v1.p.rapidapi.com/apiservices/autosuggest/v1.0/CA/CAD/en-US/?query=${arriveTo}`, {
			"method": "GET",
			"headers": {
				"x-rapidapi-key": "e94756adcfmsh4384f35646a8fc5p17f530jsn906fc3f8b7a4",
				"x-rapidapi-host": "skyscanner-skyscanner-flight-search-v1.p.rapidapi.com"
			...
			.then(response => {
				response.json().then(data => {
					...
					console.log(`Departure from ${departurePlace}; Arrival at ${arrivalPlace}`);

					// get flight quotes
					fetch(`https://skyscanner-skyscanner-flight-search-v1.p.rapidapi.com/apiservices/browsequotes/v1.0/CA/CAD/en-US/${departurePlace}/${arrivalPlace}/${departDate}?inboundpartialdate=${returnDate}`, {
					"method": "GET",
					"headers": {
						"x-rapidapi-key": "e94756adcfmsh4384f35646a8fc5p17f530jsn906fc3f8b7a4",
						"x-rapidapi-host": "skyscanner-skyscanner-flight-search-v1.p.rapidapi.com"
					...
					.then(response => {
						...
						.then(data => {
							...
							console.log(`Flight Carrier: ${flightCarrier}  Departure: ${departureAirportName}  Arrival: ${arrivalAirportName}  Quote: $${flightQuotePrice} ${currencyCode}`);
							

							// fetch requests for covid and temperature info at destination
							fetch(`https://api.opencagedata.com/geocode/v1/json?key=bf9cc7921eff4de78bd861e487142a0a&pretty=1&q=${arriveTo}&no_annotations=1`)
							.then(response => {
								if(response.ok){
									response.json()
									.then(data => {
										...
										console.log(`Destination: ${searchCountry}, ThreeLetterSymbol: ${threeLetterSymbol}, Latitude: ${cityLat}, Longitude: ${cityLon}`);
										...
										.then(response => {
											...
											.then(covidData => {
												...
												console.log(`New Cases: ${covidData[0].NewCases}	Total Cases: ${covidData[0].TotalCases}		Active cases: ${covidData[0].ActiveCases}		Recovery Proportion: ${covidData[0].Recovery_Proporation}%`)
												...
												.then(response => {
													...
													.then(weatherData => {
														...
														console.log(`Current Temperature: ${weatherData.current.temp} F`);
													});
												});
...
// 					response.json()
// 					.then(covidData => {
// 						console.log(covidData); // get covid data from this object
